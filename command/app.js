...
const origOpenEditPanel = window.openEditPanel;
window.openEditPanel = function(draftId) {
    if(origOpenEditPanel) origOpenEditPanel(draftId);
    // Show the new panel
    const panel = document.getElementById('draft-edit-panel');
...
// NOTE: This only adds renderWinLoss to the existing refreshAll
// It does NOT replace refreshAll entirely
(function() {
